...
<div class="mainContainer">
    <p class="containerHeader">Requests list</p>

    <c:forEach items="${userList}" var="user">
    <div class="singleReqContainer" id="${user.id}">

    <span style="margin-top: 5px">${user.name}</span>
        <button class="smallButton">approve</button><button class="smallErrorButton" onclick="document.getElementById(${user.id}).remove()">reject</button></span>
    </div>
